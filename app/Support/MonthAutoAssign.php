...
class MonthAutoAssign
{
    ...
    public function plan(): array
    {
        ...
        foreach ($rows as $r) {
            ...
            //   2026-09-09 は「役割が埋まらなかったぶんを『未定』で人だけ入れる」動きを入れていたが、
            //   やめた。理由＝その役割ができる人がいないのに人だけ入ると、
            //   アサイン担当が「埋まっている」と思って見落とす。空いていれば一目で分かる。
            //   ※「必要ポジションの合計より運営人数が多い」ときの余り枠（openSlots の '' 枠）は
            //     これとは別。あちらは最初から役割の決まっていない枠なので今までどおり埋める。
