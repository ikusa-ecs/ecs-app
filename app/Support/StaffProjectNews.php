...
final class StaffProjectNews
{
    ...
    public const FIELDS = [
        ...
        'lodging',             // 宿泊
        // ⚠ ケータリングは**入れない**（2026-09-09 baba「スタッフに関係ないからいらない」）。
        //   お客様向けの手配なので、スタッフの動きは変わらない。戻すときはここに1行足す。
        // ⚠ 移動・車両（transport）も**入れない**（2026-09-18 baba「移動車両はいらない」）。
        //   社内の手配なので、スタッフの動きは変わらない。戻すときは 'transport' を1行足す。
    ];
