...
<style>
    ...
    .lh-btn.active { background: var(--brand-fill); color: #fff; border-color: var(--brand); }
    ...
    .cc-fill .fbar > i.mid  { background: var(--brand-fill); }
    ...
    .open-btn {
      ...
      background: var(--brand-fill); color: #fff; text-decoration: none;
    }
    .open-btn:hover { background: var(--brand-fill-hover); }
    ...
    .edit-btn.on { background: var(--brand-fill); color: #fff; border-color: var(--brand); }
    ...
    html[data-theme="dark"] .board-controls select { background: var(--surface-2); color: var(--ink); border-color: var(--field-line); }
    html[data-theme="dark"] .lh-btn { background: var(--surface-3); border-color: var(--field-line); }
    html[data-theme="dark"] .lh-btn.active { color: #ffffff; }
    /* 日付の帯 */
    html[data-theme="dark"] .day-head { box-shadow: 0 2px 6px rgba(0, 0, 0, .5); }
    html[data-theme="dark"] .day-head .d-pool .remain.ok { color: var(--ok-ink); }
    html[data-theme="dark"] .day-head .day-bulk { background: var(--surface-3); color: var(--ink); border-color: var(--field-line); }
    html[data-theme="dark"] .day-head .day-bulk:hover { background: var(--surface-hover); }
    html[data-theme="dark"] .day-head .day-bulk.auto { background: var(--warn-soft); border-color: var(--warn-line); color: var(--warn-ink); }
    ...
    html[data-theme="dark"] .xcase.same { color: var(--danger-ink); }
    html[data-theme="dark"] .xcase.cont { color: var(--ok-ink); }
    html[data-theme="dark"] .renkin-badge { background: var(--chip-bg); color: var(--chip-ink); }
    html[data-theme="dark"] .renkin-badge.hi { color: var(--danger-ink); }
    html[data-theme="dark"] .cc-nocontent { color: var(--warn-ink); }
    /* 状態バッジ */
    html[data-theme="dark"] .sb.todo { color: var(--warn-ink); }
    html[data-theme="dark"] .sb.adj  { background: var(--info-soft); color: var(--info-ink); }
    html[data-theme="dark"] .sb.fix  { color: var(--ok-ink); }
    /* 充足バー・ポジションランプ・タグ */
    html[data-theme="dark"] .cc-fill .fbar { background: var(--chip-bg); }
    ...
    html[data-theme="dark"] .m-st.fix  { color: var(--ok-ink); border-color: var(--ok-line); }
    html[data-theme="dark"] .kari-warn { background: var(--warn-soft); color: var(--warn-ink); }
    html[data-theme="dark"] .m-note { color: #b8a6f5; }
    html[data-theme="dark"] .m-patrol { background: var(--info-soft); color: var(--info-ink); }
    html[data-theme="dark"] .m-kenin { background: var(--accent2-soft); color: #b8a6f5; }
    html[data-theme="dark"] .m-remark { color: var(--muted); }
    html[data-theme="dark"] .mem-row .m-pos-sel { background: var(--surface-2); }
    html[data-theme="dark"] .mem-row .m-lv.mid { background: var(--chip-bg); color: var(--chip-ink); }
    html[data-theme="dark"] .mem-row .m-lv.vet { color: var(--ok-ink); }
    html[data-theme="dark"] .cand-toggle { color: var(--warn-ink); }
    html[data-theme="dark"] .auto-btn { background: var(--surface-3); }
    /* 社員・派遣・確度 */
    html[data-theme="dark"] .m-type.emp   { background: var(--info-soft); color: var(--info-ink); }
    html[data-theme="dark"] .m-type.haken { background: var(--accent2-soft); color: #b8a6f5; }
    html[data-theme="dark"] .ymk.b { color: var(--warn-ink); }
    html[data-theme="dark"] .ymk.c { background: var(--chip-bg); color: var(--chip-ink); }
    html[data-theme="dark"] .m-name.emp   { color: var(--info-ink); }
    html[data-theme="dark"] .m-name.haken { color: #b8a6f5; }
    html[data-theme="dark"] .fix-emp { background: var(--info-soft); color: var(--info-ink); border-color: #2c5070; }
    html[data-theme="dark"] .hk-row { background: var(--accent2-soft); }
    html[data-theme="dark"] .hk-st.asked { color: var(--warn-ink); }
    html[data-theme="dark"] .hk-st.fixed { color: var(--ok-ink); }
    html[data-theme="dark"] .hk-st.cancelled { background: var(--chip-bg); color: var(--chip-ink); }
    /* ⚠ かぶりの赤は社員の青より「あと」に書く（ふつうの指定と同じ順番）。 */
    html[data-theme="dark"] .m-name.dup { color: var(--danger-ink); }
    /* 希望者の色分け */
    html[data-theme="dark"] .cand-row.multi-apply { background: var(--warn-soft); }
    html[data-theme="dark"] .cand-row.multi-cal   { background: var(--accent2-soft); }
    html[data-theme="dark"] .cand-row.cal-one     { background: var(--info-soft); }
    html[data-theme="dark"] .cand-row .cand-note { color: var(--muted); }
    html[data-theme="dark"] .cstat.apply2 { color: var(--danger-ink); }
    html[data-theme="dark"] .cstat.cal2   { background: var(--accent2-soft); color: #b8a6f5; }
    html[data-theme="dark"] .cstat.cal1   { background: var(--info-soft); color: var(--info-ink); }
    html[data-theme="dark"] .cstat.only   { background: var(--chip-bg); color: var(--chip-ink); }
    html[data-theme="dark"] .cstat.done   { color: var(--ok-ink); }
    ...
    html[data-theme="dark"] .cand-row.picked { background: var(--surface-3); }
    html[data-theme="dark"] .cand-row.busy { background: var(--danger-soft); border-color: var(--danger-line); }
    html[data-theme="dark"] .cstat.busy { color: var(--danger-ink); }
    /* 手動編集の操作・メンバー追加パネル */
    html[data-theme="dark"] .edit-btn { background: var(--surface-3); border-color: var(--field-line); }
    html[data-theme="dark"] .edit-btn.on { color: #ffffff; }
    html[data-theme="dark"] .add-row .mini { background: var(--surface-3); }
    html[data-theme="dark"] .pick-box { background: var(--panel); }
    html[data-theme="dark"] .pick-box .pk-q { background: var(--surface-2); color: var(--ink); }
    html[data-theme="dark"] .pick-box .pk-item:nth-child(even) { background: var(--surface-2); }
    html[data-theme="dark"] .pick-box .pk-item:hover { background: var(--brand-soft); }
    html[data-theme="dark"] .pick-box .pk-item.busy { background: var(--danger-soft); }
    html[data-theme="dark"] .pick-box .pk-item.busy:hover { background: #4a2424; }
    html[data-theme="dark"] .pick-box .pk-item .busy-tag { color: var(--danger-ink); }
    html[data-theme="dark"] .pick-box .pk-sep { background: var(--danger-soft); color: var(--danger-ink); border-top-color: var(--danger-line); }
    html[data-theme="dark"] .pick-box .pk-spot { background: var(--surface-2); }
    /* 凡例の色見本（上の色分けと同じ色にそろえる） */
    html[data-theme="dark"] .legend .sw.a { background: var(--warn-soft); }
    html[data-theme="dark"] .legend .sw.c1 { background: var(--info-soft); }
    html[data-theme="dark"] .legend .sw.c2 { background: var(--accent2-soft); }
