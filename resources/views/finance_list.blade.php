...
<style>
  ...
  html[data-theme="dark"] .fl-bar select { background: var(--surface-2); color: var(--ink); border-color: var(--field-line); }
  html[data-theme="dark"] .fl-kpi { background: var(--panel); }
  html[data-theme="dark"] .fl-kpi.profit .num { color: var(--ok-ink); }
  html[data-theme="dark"] .fl-kpi.profit .num.minus { color: var(--danger-ink); }
  html[data-theme="dark"] .fl-kpi.todo .num { color: var(--warn-ink); }
  html[data-theme="dark"] table.fl { background: var(--panel); }
  html[data-theme="dark"] table.fl th { background: var(--surface-2); color: var(--muted); }
  html[data-theme="dark"] table.fl tfoot td { border-top-color: var(--warn-line); }
  html[data-theme="dark"] table.fl tr.unfilled td { background: #2a2418; }
  html[data-theme="dark"] table.fl td.minus { color: var(--danger-ink); }
  html[data-theme="dark"] .pill.ok { color: var(--ok-ink); }
  html[data-theme="dark"] .pill.todo { color: var(--warn-ink); }
  html[data-theme="dark"] .pill.late { color: var(--danger-ink); }
  html[data-theme="dark"] .pill.day { background: var(--chip-bg); color: var(--chip-ink); }
</style>
@endverbatim
@endpush
