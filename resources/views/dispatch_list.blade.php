...
<style>
  ...
  .dl-btn { padding: 6px 14px; border: 1px solid var(--brand-dark); border-radius: 8px; font-size: 13px;
    font-weight: 700; font-family: inherit; background: var(--brand-fill); color: #fff; cursor: pointer; text-decoration: none; }
  ...
  html[data-theme="dark"] .dl-bar input { background: var(--surface-2); color: var(--ink); border-color: var(--field-line); }
  ...
  html[data-theme="dark"] table.dl th { background: var(--surface-2); color: var(--muted); }
  html[data-theme="dark"] .dl-day { color: var(--ink); }
  html[data-theme="dark"] .st.asked { color: var(--warn-ink); }
  html[data-theme="dark"] .st.fixed { color: var(--ok-ink); }
  html[data-theme="dark"] .st.cancelled { background: var(--chip-bg); color: var(--chip-ink); }
  html[data-theme="dark"] .fill.short { color: var(--danger-ink); }
  html[data-theme="dark"] .fill.full { color: var(--ok-ink); }
  html[data-theme="dark"] .dl-in { background: var(--surface-2); color: var(--ink); border-color: var(--field-line); }
  html[data-theme="dark"] .dl-x { color: var(--danger-ink); }
  html[data-theme="dark"] .dl-empty { background: var(--panel); }
  html[data-theme="dark"] .dl-saved { color: var(--ok-ink); }
