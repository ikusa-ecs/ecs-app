...
<div class="pi-wrap">
  ...
  <div class="pi-card">
    ...
    <div class="pi-cols">
      ...
      所属（社員のみ：イベプラ/セールス/クリエイティブ/経営管理/マーケティング/イベプロ/プロダクション/ビジパ/ARENA/あそ研） ／ 入社日（例 2025-04-01） ／ 通算経験回数（スタッフのみ・数字） ／
...
<script>
  ...
  var PI_HEADERS = ['種別', '氏名', 'ふりがな', 'メール', '事務所', '所属', '入社日', '通算経験回数', 'できるポジション'];

  function piDownloadTemplate() {
    var rows = [
      PI_HEADERS,
      ['スタッフ', '山田花子', 'やまだ はなこ', 'hanako@example.com', '東京', '', '2025-04-01', '12', 'OP,MC,軍師'],
      ['社員', '鈴木一郎', 'すずき いちろう', 'ichiro@example.com', '大阪', 'イベプラ', '2020-04-01', '', ''],
    ];
