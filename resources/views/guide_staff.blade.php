...
<div class="wrap">
  ...
  <section id="entry">
    ...
    <ol class="steps">
      ...
      <li><b>カレンダーで見る</b> — <span class="key">📅 カレンダー</span> に切り替えると、<b>日付ごとに募集案件が並びます</b>。予定と見くらべながら探せます。案件をタップすると<b>すぐ下に案件の一覧が開いて、その案件のところまで動きます</b>。ほかの案件も見られて、そのまま応募できます。</li>
    ...
    <table>
      ...
      <tr>
        ...
        <td><b>カレンダー表示が<u>見やすくなりました</u>。</b><br>
          日付のマスに、<b>集合〜解散の時間と場所</b>も出るようになりました。<br>
          ※ <b>スマホでは、案件がある日だけを日付順に縦に並べます</b>（横に7つ並ぶ形だと、文字が小さくて読めないためです）。<br>
          ※ 案件をタップすると、<b>その1件だけでなく案件の一覧が出て、タップした案件のところまで動きます</b>。
          ほかの案件もそのまま見られて、応募もできます。</td>
      </tr>
      <tr>
        <td>2026-09-02</td>
