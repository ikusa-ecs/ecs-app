...
<div class="wrap">
  ...
  <section id="entry">
    ...
    <ol class="steps">
      ...
      <li><b>カレンダーで見る</b> — <span class="key">📅 カレンダー</span> に切り替えると、<b>日付ごとに募集案件が並びます</b>。予定と見くらべながら探せます。案件をタップすると、リストのその案件へ移動します（応募はそこから）。</li>
    ...
    <table>
      ...
      <tr>
        ...
        <td><b>「募集中の案件」タブを<u>カレンダーでも見られる</u>ようになりました。</b><br>
          ...
          ※ 色は <b>緑＝募集中／茶＝エントリー中／グレー＝締切</b>です。追加案件は左に赤い線が付きます。<br>
          ※ <b>案件をタップすると、リストのその案件へ移動します。</b>応募（エントリー）はそこからしてください。<br>
