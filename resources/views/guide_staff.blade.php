...
<div class="wrap">
  ...
  <section id="login">
    ...
    <ol class="steps">
      ...
      <li><b>初めてのときは初期設定</b> — パスワード（8文字以上）を決めて、<b>ふりがな</b>（必須）と、身長・靴のサイズなどのプロフィールを入力します（あとで変えられます）。<b>IKUSAで働き始めた年月</b>もここで入れてください（分かる範囲で・任意）。</li>
    </ol>
    <div class="note">
      コードが届かないときは、入力画面の「<b>コードを再送する</b>」を押してください（迷惑メールフォルダもご確認ください）。<br>
      パスワードを忘れたときは、ログイン画面の「<b>パスワードをお忘れですか</b>」から、メールで再設定できます。
    </div>
  </section>
  ...
  <section id="wish">
    ...
    <ol class="steps">
      <li><b>「稼働希望」タブを開く</b> — <b>今月ぶん</b>が開きます。上に「◯月分の希望を入力中／締切：◯月◯日まで」と出ます。</li>
  ...
  <section id="profile">
    ...
    <ul>
      <li><b>プロフィール編集</b> — 事務所・身長・靴・服のサイズ・最寄り駅・一言アピール・好きなコンテンツ／苦手なコンテンツなど。<b>当日の衣装の準備やメンバー決めの参考になります</b>ので、ぜひ埋めてください。</li>
