...
<div class="wrap">
  ...
  <section id="login">
    ...
    <div class="note">
      <b>毎回コードを入れるのが面倒なとき</b>（2026-09-03から）<br>
      コードを入れる画面に「<b>この端末では次回からコードを省略する（30日間）</b>」というチェックがあります。
      ここにチェックを入れてからコードを入れると、<b>その端末では30日間コードを聞かれなくなります</b>。<br>
      ※ <b>自分のスマホ・パソコンのときだけ</b>入れてください。<b>共用の端末では入れないでください</b>（次に使う人があなたのアカウントに入れてしまいます）。<br>
      ※ ログアウトしても、この記憶は残ります（毎回消えると意味がないため）。<br>
      ※ やめたいときは、スタッフ画面いちばん下の「<b>アカウント</b>」にある
      「<b>この端末の記憶を解除する（2段階認証）</b>」を押してください。<br>
      ※ <b>パスワードを変えると、記憶した端末はすべて自動で解除されます</b>（安全のため）。
    </div>
  ...
  <section id="entry">
    ...
    <ol class="steps">
      ...
      <li><b>カレンダーで見る</b> — <span class="key">📅 カレンダー</span> に切り替えると、<b>日付ごとに募集案件が並びます</b>。予定と見くらべながら探せます。<b>日付のマスをタップすると、その日の案件が全部下に出ます</b>。そのまま応募できます。</li>
  ...
  <section id="history">
    ...
    <table>
      ...
      <tr>
        <td>2026-09-03</td>
        <td><b>ログインのたびに6桁コードを入れる手間をなくせるようになりました。</b>（「毎回入れるのが面倒」というお声から）<br>
          コードを入れる画面の「<b>この端末では次回からコードを省略する（30日間）</b>」にチェックを入れてください。
          その端末では30日間、コードを聞かれなくなります。<br>
          ※ <b>自分のスマホ・パソコンのときだけ</b>にしてください（共用の端末では入れないでください）。<br>
          ※ やめたいときは「<b>アカウント</b>」の「<b>この端末の記憶を解除する（2段階認証）</b>」から。
          パスワードを変えたときも自動で解除されます。</td>
      </tr>
      <tr>
        <td>2026-09-03</td>
        <td><b>「IKUSAで働き始めた年月」が、<u>年・月・日を選ぶだけ</u>になりました。</b>（「入力しにくい」というお声から）<br>
          これまではカレンダーが今月から開くので、何年も前まで戻すのが大変でした。
          いまは<b>「2023年」「11月」「1日」</b>と3回選ぶだけです。<br>
          ※ <b>日にちが分からなければ「1日」のままで構いません</b>（最初から1日が入っています）。<br>
          ※ ⚠ <b>生年月日ではありません。</b>IKUSAで働き始めた日を選んでください。
          間違いが多いので、入力欄の上に<b>赤い注意</b>を出し、選ぶと下に「<b>勤続◯年◯か月</b>」と出るようにしました。
          「勤続21年」のようにおかしな数字が出たら、生年月日を選んでしまっています。</td>
      </tr>
      <tr>
        <td>2026-09-02</td>
        <td><b>カレンダー表示が<u>見やすくなりました</u>。</b><br>
          <b>日付のマスをタップすると、その日の案件が全部下に出ます</b>（例：9/29 をタップすると、その日の5件）。<br>
          ※ 案件の帯は小さいので、<b>マスのどこをタップしても開きます</b>。<br>
          ※ スマホでは<b>マスの中は案件名だけ</b>です。<b>集合〜解散と場所は、タップすると下に出ます</b>。
          案件が多い日は3件まで出て、残りは「＋◯件」とまとまります。</td>
      </tr>
      <tr>
        <td>2026-09-02</td>
        <td><b>「設定」タブで<u>「IKUSAで働き始めた年月」を直せる</u>ようになりました。</b><br>
          これまでは<b>いちばん最初の初期設定のときにしか入れられず、間違えても直せません</b>でした。<br>
          ※ ⚠ <b>生年月日ではありません。</b>IKUSAで働き始めた日を入れてください。<br>
          ※ 日にちが分からなければ<b>1日</b>で構いません。名簿の並び順と、区分（新人／中堅／ベテラン）に使います。</td>
      </tr>
      <tr>
        <td>2026-09-01</td>
