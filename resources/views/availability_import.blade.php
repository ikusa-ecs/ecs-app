...
@section('content')
  ...
  <div class="panel a-wrap">
    <p class="a-note">
      ...
      ⚠ <b>年月は必ず選んでください。</b>シートの見出しは「9/6」「5(土)」のように年が書いていないため、
      選ばないと<b>去年の日付として入ってしまいます</b>。<br>
      ⚠ 貼り付けるときは、<b>日付が並んだ見出しの行から下</b>をまとめて選んでコピーしてください。<br>
      日付の見出しは<b>「9/6」でも「9月」＋「5(土)」でも読めます</b>（東京のシートは後者です）。
      カッコの中の曜日が合わないときは、<b>別の月のシートかもしれないので取り込みません</b>。
    </p>
  ...
  @isset($preview)
    @if ($preview['errors'])
      <div class="panel a-wrap" style="margin-top:16px;">
        <div class="a-warn">
          <b>読めなかったところがあります（ここに出たぶんは取り込みません。手で入れてください）</b><br>
