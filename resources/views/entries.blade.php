...
@verbatim
  <style>
    ...
    html[data-theme="dark"] .ent-filter select { background:var(--surface-2); color:var(--ink); border-color:var(--field-line); }
    html[data-theme="dark"] .ent-filter .f-today { background:var(--surface-3); color:var(--ink); border-color:var(--field-line); }
    html[data-theme="dark"] .ent-filter .f-today:hover { background:var(--surface-hover); }
    ...
    html[data-theme="dark"] .day-chip:hover { background:var(--surface-3); }
    ...
    html[data-theme="dark"] .day-chip.clear { background:var(--surface-3); color:var(--ink); }
    html[data-theme="dark"] .day-chip.around { background:var(--info-soft); border-color:#2c5070; color:var(--info-ink); }
    ...
    html[data-theme="dark"] .sum-card .num.warn { color:var(--danger-ink); }
    ...
    html[data-theme="dark"] .ecase-counts .c.short b { color:var(--danger-ink); }
    html[data-theme="dark"] .ecase-counts .c.filtered { color:var(--warn-ink); }
    /* バッジ類（意味の色は保つ） */
    html[data-theme="dark"] .dt-badge { background:var(--chip-bg); color:var(--chip-ink); border-color:var(--field-line); }
    html[data-theme="dark"] .st-badge.todo { background:var(--chip-bg); color:var(--chip-ink); }
    html[data-theme="dark"] .st-badge.adj  { background:var(--warn-soft); color:var(--warn-ink); }
    html[data-theme="dark"] .st-badge.fix  { background:var(--ok-soft); color:var(--ok-ink); }
    html[data-theme="dark"] .st-badge.pub  { background:#12302c; color:#7ed8c6; }
    html[data-theme="dark"] .rec-badge.open  { background:var(--ok-soft); color:var(--ok-ink); }
    html[data-theme="dark"] .rec-badge.close { background:var(--chip-bg); color:#9aa2ad; }
    /* エントリー者テーブル */
    ...
    html[data-theme="dark"] .ent-table tr.assigned { background:var(--surface-2); }
    ...
    html[data-theme="dark"] .wc-dow.wc-sat { color:var(--info-ink); }
    ...
    html[data-theme="dark"] .wc-n { background:var(--ok-soft); color:var(--ok-ink); }
    html[data-theme="dark"] .wc-cases a { background:var(--warn-soft); color:var(--warn-ink); }
    html[data-theme="dark"] .wc-p { color:var(--ink); }
    html[data-theme="dark"] .wc-p.ent { color:var(--warn-ink); }
    html[data-theme="dark"] .wc-p.asg { color:var(--muted-dim); }
    html[data-theme="dark"] .wc-none { color:var(--muted-dim); }
    /* その日の稼働希望・レベル・ポジション */
    html[data-theme="dark"] .e-wish.ok { background:var(--ok-soft); color:var(--ok-ink); }
    html[data-theme="dark"] .e-wish.ng { background:var(--danger-soft); color:var(--danger-ink); }
    html[data-theme="dark"] .e-lv.new { background:var(--accent2-soft); color:#b8a6f5; }
    html[data-theme="dark"] .e-lv.mid { background:var(--chip-bg); color:var(--chip-ink); }
    html[data-theme="dark"] .e-lv.vet { background:#3a2a16; color:#f0a860; }
    html[data-theme="dark"] .e-pos { background:var(--chip-bg); color:var(--chip-ink); }
    html[data-theme="dark"] .e-pos.key { background:var(--info-soft); color:var(--info-ink); }
    html[data-theme="dark"] .e-stat.assigned { color:var(--ok-ink); }
    html[data-theme="dark"] .e-stat.waiting { color:var(--muted); }
    html[data-theme="dark"] .e-src.ent { background:var(--ok-soft); color:var(--ok-ink); }
    html[data-theme="dark"] .e-src.cal { background:var(--info-soft); color:var(--info-ink); }
    html[data-theme="dark"] .ent-note { color:var(--muted); }
    html[data-theme="dark"] .ent-remark { background:var(--surface-2); color:var(--ink); border-color:var(--field-line); }
    /* 月ごと */
    ...
    html[data-theme="dark"] .ent-chip { background:var(--chip-bg); color:var(--chip-ink); }
    html[data-theme="dark"] .ent-chip.assigned { background:var(--ok-soft); color:var(--ok-ink); }
    /* 月ごとの一覧表（スタッフ×案件） */
    ...
    html[data-theme="dark"] table.mtx thead th { background:var(--surface-2); color:var(--muted); }
    ...
    html[data-theme="dark"] table.mtx td.entcol { background:var(--surface-2); }
    html[data-theme="dark"] table.mtx thead th.staffcol { background:var(--surface-2); color:var(--muted); }
    ...
    html[data-theme="dark"] table.mtx th.totcol { background:var(--surface-2); }
    html[data-theme="dark"] table.mtx .m-asg { color:var(--ok-ink); }
    html[data-theme="dark"] table.mtx .m-tmp { background:var(--warn-soft); color:var(--warn-ink); border-color:var(--warn-line); }
    html[data-theme="dark"] table.mtx .m-ent { color:var(--warn-ink); }
    html[data-theme="dark"] table.mtx .m-none { color:var(--muted-dim); }
    html[data-theme="dark"] table.mtx .m-cal { background:var(--info-soft); color:var(--info-ink); border-color:#2c5070; }
    html[data-theme="dark"] table.mtx .m-ng { color:var(--danger-ink); }
    html[data-theme="dark"] table.mtx td.assignable:hover { background:var(--surface-hover); }
    html[data-theme="dark"] table.mtx td.is-tmp { background:var(--warn-soft); }
    html[data-theme="dark"] table.mtx td.is-fix { background:var(--ok-soft); }
    html[data-theme="dark"] table.mtx td.is-cal { background:var(--info-soft); }
    html[data-theme="dark"] table.mtx td.is-ng  { background:var(--danger-soft); }
    html[data-theme="dark"] table.mtx td.is-pub { background:#12302c; }
    html[data-theme="dark"] table.mtx .m-x { color:#c9a0a0; }
    html[data-theme="dark"] table.mtx .m-x:hover { color:var(--danger-ink); }
    html[data-theme="dark"] table.mtx tbody tr:hover td { background:var(--surface-3); }
    html[data-theme="dark"] table.mtx tbody tr:hover td.staffcol { background:var(--surface-hover); }
    html[data-theme="dark"] table.mtx tfoot td { background:var(--surface-2); color:var(--ink); }
