...
@verbatim
      ...
      <div class="panel">
        ...
        <div class="cols-help" style="margin-top:16px;">
          ...
          <u>基本情報</u>　<code>区分</code>（通常案件/追加案件）　<code>確度</code>（確定/Aヨミ/Bヨミ/Cヨミ）　<code>開催日</code>（必須・2026-07-20 の形式）　<code>宿泊</code>（無/前泊有 等）　<code>案件名</code>（必須・コンテンツ名）　<code>案件規模</code>（大型/中型/小型/該当なし）　<code>営業担当</code><br>
...
<script>
  ...
  function downloadTemplate() {
    const header = ['区分','確度','開催日','宿泊','案件名','案件規模','営業担当','実施形態','配信種別','クライアント','代理店名','複数案件','日程種別','紐づく本番案件','運営場所','担当体制','集合時間','解散時間','イベント入場','イベント開始','イベント終了','運営人数','お客様人数','チーム数','リピート','音響機材','ロゴ','カメラ','事例記事','動画','会場住所','屋内外','集合形式','お酒','ケータリング','移動車両','スタッフ募集','ディレクター','物品担当','運営シートURL','準備:LINE概要送付','準備:引き継ぎ','準備:台本','備考'];
