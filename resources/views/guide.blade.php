...
<div class="wrap">
  ...
  <section id="history">
    ...
    <table>
      ...
      <tr>
        <td>2026-08-21</td>
        <td><b>公開ボードで「案件登録の備考」も読めるようにしました。</b>
          <b>備考は2種類あります</b>：案件登録の備考（社員向け・案件一覧やチャットワーク書き出しに出る）と、
          公開ボードの備考（<b>公開作業の担当メモ</b>）。別々の項目なので、案件登録で書いた備考は公開ボードの備考欄には入りません。
          分かりにくいので、公開ボードの「💬 備考」を開くと<b>案件登録の備考も表示</b>されるようにしました（読むだけ・直すときは「直す」から案件登録へ）。
          なお<b>スタッフに見せたいこと</b>は、どちらの備考でもなく「<b>📣 スタッフに伝えること</b>」に書きます。</td>
      </tr>
      <tr>
        <td>2026-08-21</td>
